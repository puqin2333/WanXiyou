...
- (WXYScoreDetailView *)detailView {
    if (_detailView == nil) {
        _detailView = [[WXYScoreDetailView alloc] init];
...
- (void)selectToShowDetailWithContentOffsetY:(CGFloat)contentOffsetY {
    ...
    [self.detailView setFrame:CGRectMake(0, CGRectGetMaxY(self.frame) - (kScreenHeight - 100*kScreenRatio - 30*2*kScreenRatio),
