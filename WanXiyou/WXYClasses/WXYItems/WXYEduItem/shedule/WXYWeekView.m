    ...
    for (NSInteger i = 0; i <= 7; i++) {
        ...
        if (i == 0) {
            ...
            if (i == s) {
                ...
                weekLabel.backgroundColor = [UIColor colorWithRed:0.94f green:0.94f blue:0.94f alpha:1.00f];
                weekLabel.text = weekDays[i - 1];
                weekLabel.font = [UIFont fontWithName:@"Avenir-BlackOblique" size:12];
                weekLabel.textColor = [UIColor colorWithRed:0.65f green:0.65f blue:0.65f alpha:1.00f];
                weekLabel.textAlignment = NSTextAlignmentCenter;
                [weekHeaderView addSubview:weekLabel];
            }
        }
